...
def check_test(data_dir):
    ...
    res = calculate_metrics(test_output_path, gt_path)
...
def grade(data_path):
    ...
    if not result.startswith("Ok"):
        ...
        res = {"description": result[4:], "mark": 2}
